export default function () {
    return {
        ...
        reportTestDone (name, testRunInfo, meta) {
            ...
            this._compileTestTable(name, testRunInfo, hasErr, result, description, requirement);
            if (hasErr)
        ...
        _compileTestTable (name, testRunInfo, hasErr, result, description, requirement) {
        ...
        reportTaskDone (endTime, passed/*, warnings*/) {
            ...
            table += this.indentString('<th>Test Description</th>', 2);
            table += this.indentString('<th>Browsers</th>', 2);
            table += this.indentString('<th>Requirement</th>', 2);
